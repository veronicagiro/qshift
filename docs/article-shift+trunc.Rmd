...
Let us see how it the other distribution functions works with other distributions.

Let us consider Poisson distribution and distribution function.

First of all functions for truncated distribution and for shifted distributio have to be defined:
